...
import pytest
import requests
from helpers import generate_random_string, login_and_get_courier_id
from data import Url, login_valid, Registration, ResponseBody
...
class TestCreateCourier:
    ...
    def test_create_courier(self, create_courier):
        registration = requests.post(f'{Url.COURIER_CREATE_URL}', json=create_courier[0])
